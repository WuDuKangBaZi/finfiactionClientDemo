...
def insert(invoice_number, order_id, invoice_date, subtotal, tax, total_amount, payment_status, buyer_enterprise,
    ...
    sql_str = f"insert into Invoices(invoice_number, order_id, invoice_date, subtotal, tax, total_amount, payment_status, buyer_enterprise, seller_enterprise, invoice_type) values(\'{invoice_number}\', \'{order_id}\', \'{invoice_date}\', {subtotal}, {tax}, {total_amount}, \'{payment_status}\', \'{buyer_enterprise}\', \'{seller_enterprise}\', \'{invoice_type}\')"
    print(sql_str)
